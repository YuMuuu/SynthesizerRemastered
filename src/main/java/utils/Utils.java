...
public class Utils {
    public static void handleProcesure(Procedure procedure, boolean printStackTrace) {
        try {
            procedure.invoke();
        } catch (Exception e) {
            if (printStackTrace) {
    ...
    public static class ParameterHandring {
        ...
        static {
            try {
                ...
                throw new ExceptionInInitializerError("cannnot construct robot instance");
            }
        }
    }

    public static class windowsDesign {
